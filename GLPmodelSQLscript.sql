...
CREATE TABLE IF NOT EXISTS `GLP`.`Fixtures` (
  ...
  PRIMARY KEY (`fid`, `homeID`, `awayID`, `date`),
  INDEX `Seasons_idx` (`Seasons_seasonid` ASC) VISIBLE,
  ...
  CONSTRAINT `Seasons`
    ...
    REFERENCES `GLP`.`Seasons` (`seasonid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `Leagues`
...
CREATE TABLE IF NOT EXISTS `GLP`.`Season_awards` (
  ...
  INDEX `SA_Seasons_seasonid_idx` (`Seasons_seasonid` ASC) VISIBLE,
  INDEX `SA_Players_pid_idx` (`Players_pid` ASC) VISIBLE,
  CONSTRAINT `FK_Seasons_seasonid_FK`
    FOREIGN KEY (`Seasons_seasonid`)
    REFERENCES `GLP`.`Seasons` (`seasonid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `GLP`.`Seasons`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GLP`.`Seasons` (
...
CREATE TABLE IF NOT EXISTS `GLP`.`Teams` (
  ...
  INDEX `Season_seasonid_idx` (`Seasons_seasonid` ASC) VISIBLE,
  CONSTRAINT `League_lid`
    FOREIGN KEY (`League_lid`)
    REFERENCES `GLP`.`Leagues` (`lid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `Season_seasonid`
    FOREIGN KEY (`Seasons_seasonid`)
    REFERENCES `GLP`.`Seasons` (`seasonid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
